...
for i = 1:length(pos_mt)
    ...
    title('Amplitude - Transfer functions below Schröeder frequency')
    ...
    title('Phase - Transfer functions below Schröeder frequency')
    str = 'frequency $[\frac{\textrm{rad}}{\textrm{s}}]$';
    xlabel(str, 'Interpreter','latex')
    ...
    title('Amplitude - Values at the resonant frequencies below Schröeder frequency')
    str = 'frequency $[\frac{\textrm{rad}}{\textrm{s}}]$';
    xlabel(str, 'Interpreter','latex')
    ylabel('$|\mathrm{H}|$ [dB]', 'Interpreter','latex')
    ylim([-70 0])
    ...
    title('Phase - Values at the resonant frequencies below Schröeder frequency')
    str = 'frequency $[\frac{\textrm{rad}}{\textrm{s}}]$';
    xlabel(str, 'Interpreter','latex')
    ylabel('$$\times \pi[\mathrm{rad}]$$', 'Interpreter','latex')
    xlim([0 SCHROEDER_FREQUENCY*2*pi])
